...
== Цели и задачи НИР
Целью настоящей работы является разработка оптимизированного табличного метода доступа к данным
в СУБД PostgreSQL, основанного на принципе undo--logging и сокращающего зависимость хранилища
от встроенного механизма очистки (vacuum).

Для достижения поставленной цели необходимо решить следующие задачи:
+ Сформулировать требования к новому методу хранения кортежей и определить границы его применимости.
+ Спроектировать архитектуру расширения PostgreSQL, реализующего табличный метод доступа.
+ Реализовать расширение, обеспечив операции чтения и записи данных в хранилище.
+ Провести апробацию расширения и сравнить его производительность со штатными методами доступа.
